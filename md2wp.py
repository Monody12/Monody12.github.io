...
# 配置你自己的地址 账号密码
wordpress_xmlrcpath: str = 'https://182.92.224.215:666/'  # 'https://blog.1kye.com/xmlrpc.php'
wordpress_user_name: str = 'monody'  # 'YourName'
wordpress_user_passwd: str = 'monody12'  # 'Password'

image_dir_path: str = 'D:\\Documents\\hexo\\Monody12.github.io\\source\\images'
